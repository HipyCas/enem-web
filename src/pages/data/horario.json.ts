  ...
  "22": [
    {
      name: "Check-in",
      description:
        "Te recibiremos al evento con la entrega de tu acreditación y un pack de bienvenida. **Esto no es el check-in al alojamiento**. **Es necesario realizar el check-in para asistir**. Si tienes cualquier problema para realizar el check-in en el horario previsto, contáctanos por correo.",
      descriptionLong:
        "Te recibiremos al evento con la entrega de tu acreditación y un pack de bienvenida. **Esto no es el check-in al alojamiento**. **Es necesario realizar el check-in para asistir**. Si tienes cualquier problema para realizar el check-in en el horario previsto, contáctanos por correo.",
    ...
    },
    {
      ...
      descriptionLong:
        "En esta charla vamos a describir la filosofía que subyace en los algoritmos de la Geometría Computacional, una rama de las matemáticas que vive a medio camino entre las matemáticas y la computación.",
      location: "Sala ENEM GRX (Aula Magna)",
    ...
    },
    {
      ...
      descriptionLong:
        ...
        D. Manuel Pérez Mendoza, Decano de la Facultad de Ciencias de la Universidad de Granada.
    ...
    },
    {
      ...
      descriptionLong:
        ...
        - Fusión suave de crema de ave, cocción de verduras, hortalizas y tubérculos, finalizada con delicias frescas del mar;
...
Donde $\lambda\in\mathbb{R}$ y $x$ pertenece a un espacio de Banach de dimensión infinita. En esta charla, veremos como usar la teoría abstracta de bifurcación para ver la existencia de diferentes soluciones en la ecuación de Euler: V-estados, soluciones no uniformes que rotan, o soluciones de tipo Karman Vortex Street.`,
    ...
    {
      name: "Comida",
      description: "Recuperaremos fuerzas con una comida rica y variada.",
      descriptionLong: "Recuperaremos fuerzas con una comida rica y variada.",
      location:
    ...
    {
      name: "Cena",
      description: "Recuperaremos fuerzas con una cena rica y variada.",
    ...
    {
      name: "Noche de juegos de mesa variados",
      description:
  ...
  "24": [
    ...
    },
    {
      name: "Pechakuchas",
      description:
        "Algunas de las entidades colaboradoras tratarán de cautivarnos en una dinámica de formato ágil y de corta duración en la que tendrán que condensar su mensaje para causar impacto y generar curiosidad.",
      descriptionLong:
        "Algunas de las entidades colaboradoras tratarán de cautivarnos en una dinámica de formato ágil y de corta duración en la que tendrán que condensar su mensaje para causar impacto y generar curiosidad.",
      location: "Sala ENEM GRX (Aula Magna)",
    ...
    {
      name: "Torneo y talleres de cubos de rubik",
      description:
  ...
  "26": [
    ...
    },
    {
      ...
      descriptionLong:
        ...
        - Lomo de orza con pimientos del padrón;
        - Crujiente de cebolla caramelizada con langostino sobre chutney de papaya;
        - Quiche loraine;
        - Brocheta de boquerón, oliva y piperada;
        - Pastela moruna;
        - Empanada de atún;
        - Atún en escabeche de cítricos;
        - Humus especiado y dulce de tomate;
        - Ensaladilla de gambas;
        - Pulpo a feira;
        - Mini hamburguesas con salsa barbacoa;
        - Chuletillas de pollo a la milanesa;
        - Cazuelita de setas y langostinos;
        - Bacalao a la vizcaína;
        - Carrillera de cerdo sobre parmentier;
        - Pasteles variados;
  ...
  "27": [
    {
      name: "Desayuno",
      description:
        "Comenzaremos la última mañana con un desayuno de buffet libre en los alojamientos correspondientes, **A la hora estipulada de finalización del desayuno habrá que estar en las actividades correspondientes, no saliendo de los alojamientos.**.",
      descriptionLong:
        "Comenzaremos la última mañana con un desayuno de buffet libre en los alojamientos correspondientes, **A la hora estipulada de finalización del desayuno habrá que estar en las actividades correspondientes, no saliendo de los alojamientos.**.",
      location:
        "Hotel Turia Granada o Residencia Universitaria Livensa Living Fuentenueva (según corresponda)",
